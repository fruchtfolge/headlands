(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@turf/turf')) :
    typeof define === 'function' && define.amd ? define(['@turf/turf'], factory) :
    (global = global || self, global.headland = factory(global.turf));
    ...
    */
    ...
    function checkIntersections(polys) {
      ...
      for (let i = 0; i < polys.length; i++) {
        ...
        try {
          ...
          const unified = index.union(...headlandsExceptCurrent.map(h => h.geometry.coordinates));
          ...
          const intersectionCoords = index.intersection(curHeadland.geometry.coordinates,unified);
    ...
    function clipHeadland(headland, poly, width) {
      ...
      const intersectionArea = index.intersection(headland.geometry.coordinates,poly.geometry.coordinates);
      ...
      headland = index.difference(intersectionArea, innerPoly.geometry.coordinates);
